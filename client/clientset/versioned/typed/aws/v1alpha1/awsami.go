...
type AwsAmiInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsAmi) (*v1alpha1.AwsAmi, error)
...
func newAwsAmis(c *AwsV1alpha1Client) *awsAmis {
	return &awsAmis{
		client: c.RESTClient(),
	}
}
...
func (c *awsAmis) UpdateStatus(awsAmi *v1alpha1.AwsAmi) (result *v1alpha1.AwsAmi, err error) {
	result = &v1alpha1.AwsAmi{}
	err = c.client.Put().
		Resource("awsamis").
		Name(awsAmi.Name).
