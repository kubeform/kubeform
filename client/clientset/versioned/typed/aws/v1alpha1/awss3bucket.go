...
type AwsS3BucketsGetter interface {
	AwsS3Buckets() AwsS3BucketInterface
}
...
type AwsS3BucketInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsS3Bucket) (*v1alpha1.AwsS3Bucket, error)
...
func newAwsS3Buckets(c *AwsV1alpha1Client) *awsS3Buckets {
	return &awsS3Buckets{
		client: c.RESTClient(),
	}
}
...
func (c *awsS3Buckets) UpdateStatus(awsS3Bucket *v1alpha1.AwsS3Bucket) (result *v1alpha1.AwsS3Bucket, err error) {
	result = &v1alpha1.AwsS3Bucket{}
	err = c.client.Put().
		Resource("awss3buckets").
		Name(awsS3Bucket.Name).
