...
type AwsOrganizationsPoliciesGetter interface {
	AwsOrganizationsPolicies() AwsOrganizationsPolicyInterface
}
...
type AwsOrganizationsPolicyInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsOrganizationsPolicy) (*v1alpha1.AwsOrganizationsPolicy, error)
...
func newAwsOrganizationsPolicies(c *AwsV1alpha1Client) *awsOrganizationsPolicies {
...
func (c *awsOrganizationsPolicies) UpdateStatus(awsOrganizationsPolicy *v1alpha1.AwsOrganizationsPolicy) (result *v1alpha1.AwsOrganizationsPolicy, err error) {
	result = &v1alpha1.AwsOrganizationsPolicy{}
	err = c.client.Put().
		Resource("awsorganizationspolicies").
		Name(awsOrganizationsPolicy.Name).
