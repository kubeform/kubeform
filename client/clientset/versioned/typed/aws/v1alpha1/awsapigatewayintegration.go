...
type AwsApiGatewayIntegrationsGetter interface {
	AwsApiGatewayIntegrations() AwsApiGatewayIntegrationInterface
}
...
type AwsApiGatewayIntegrationInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsApiGatewayIntegration) (*v1alpha1.AwsApiGatewayIntegration, error)
...
func newAwsApiGatewayIntegrations(c *AwsV1alpha1Client) *awsApiGatewayIntegrations {
...
func (c *awsApiGatewayIntegrations) UpdateStatus(awsApiGatewayIntegration *v1alpha1.AwsApiGatewayIntegration) (result *v1alpha1.AwsApiGatewayIntegration, err error) {
	result = &v1alpha1.AwsApiGatewayIntegration{}
	err = c.client.Put().
		Resource("awsapigatewayintegrations").
		Name(awsApiGatewayIntegration.Name).
