...
type AwsOpsworksInstancesGetter interface {
	AwsOpsworksInstances() AwsOpsworksInstanceInterface
}
...
type AwsOpsworksInstanceInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsOpsworksInstance) (*v1alpha1.AwsOpsworksInstance, error)
...
func newAwsOpsworksInstances(c *AwsV1alpha1Client) *awsOpsworksInstances {
...
func (c *awsOpsworksInstances) UpdateStatus(awsOpsworksInstance *v1alpha1.AwsOpsworksInstance) (result *v1alpha1.AwsOpsworksInstance, err error) {
	result = &v1alpha1.AwsOpsworksInstance{}
	err = c.client.Put().
		Resource("awsopsworksinstances").
		Name(awsOpsworksInstance.Name).
