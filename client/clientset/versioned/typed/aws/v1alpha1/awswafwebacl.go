...
type AwsWafWebAclsGetter interface {
	AwsWafWebAcls() AwsWafWebAclInterface
}
...
type AwsWafWebAclInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsWafWebAcl) (*v1alpha1.AwsWafWebAcl, error)
...
func newAwsWafWebAcls(c *AwsV1alpha1Client) *awsWafWebAcls {
...
func (c *awsWafWebAcls) UpdateStatus(awsWafWebAcl *v1alpha1.AwsWafWebAcl) (result *v1alpha1.AwsWafWebAcl, err error) {
	result = &v1alpha1.AwsWafWebAcl{}
	err = c.client.Put().
		Resource("awswafwebacls").
		Name(awsWafWebAcl.Name).
