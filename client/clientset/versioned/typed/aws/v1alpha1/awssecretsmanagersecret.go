...
type AwsSecretsmanagerSecretsGetter interface {
	AwsSecretsmanagerSecrets() AwsSecretsmanagerSecretInterface
}
...
type AwsSecretsmanagerSecretInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsSecretsmanagerSecret) (*v1alpha1.AwsSecretsmanagerSecret, error)
...
func newAwsSecretsmanagerSecrets(c *AwsV1alpha1Client) *awsSecretsmanagerSecrets {
...
func (c *awsSecretsmanagerSecrets) UpdateStatus(awsSecretsmanagerSecret *v1alpha1.AwsSecretsmanagerSecret) (result *v1alpha1.AwsSecretsmanagerSecret, err error) {
	result = &v1alpha1.AwsSecretsmanagerSecret{}
	err = c.client.Put().
		Resource("awssecretsmanagersecrets").
		Name(awsSecretsmanagerSecret.Name).
