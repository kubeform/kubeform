...
type AwsWafRegexPatternSetsGetter interface {
	AwsWafRegexPatternSets() AwsWafRegexPatternSetInterface
}
...
type AwsWafRegexPatternSetInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsWafRegexPatternSet) (*v1alpha1.AwsWafRegexPatternSet, error)
...
func newAwsWafRegexPatternSets(c *AwsV1alpha1Client) *awsWafRegexPatternSets {
...
func (c *awsWafRegexPatternSets) UpdateStatus(awsWafRegexPatternSet *v1alpha1.AwsWafRegexPatternSet) (result *v1alpha1.AwsWafRegexPatternSet, err error) {
	result = &v1alpha1.AwsWafRegexPatternSet{}
	err = c.client.Put().
		Resource("awswafregexpatternsets").
		Name(awsWafRegexPatternSet.Name).
