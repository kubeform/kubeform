...
type AwsRdsClusterInstancesGetter interface {
	AwsRdsClusterInstances() AwsRdsClusterInstanceInterface
}
...
type AwsRdsClusterInstanceInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsRdsClusterInstance) (*v1alpha1.AwsRdsClusterInstance, error)
...
func newAwsRdsClusterInstances(c *AwsV1alpha1Client) *awsRdsClusterInstances {
...
func (c *awsRdsClusterInstances) UpdateStatus(awsRdsClusterInstance *v1alpha1.AwsRdsClusterInstance) (result *v1alpha1.AwsRdsClusterInstance, err error) {
	result = &v1alpha1.AwsRdsClusterInstance{}
	err = c.client.Put().
		Resource("awsrdsclusterinstances").
		Name(awsRdsClusterInstance.Name).
