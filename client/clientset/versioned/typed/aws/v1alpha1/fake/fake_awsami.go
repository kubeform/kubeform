...
var awsamisResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awsamis"}

var awsamisKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsAmi"}
...
func (c *FakeAwsAmis) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsAmi, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awsamisResource, name), &v1alpha1.AwsAmi{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsAmis) List(opts v1.ListOptions) (result *v1alpha1.AwsAmiList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awsamisResource, awsamisKind, opts), &v1alpha1.AwsAmiList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsAmiList{ListMeta: obj.(*v1alpha1.AwsAmiList).ListMeta}
...
func (c *FakeAwsAmis) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awsamisResource, opts))
}
...
func (c *FakeAwsAmis) Create(awsAmi *v1alpha1.AwsAmi) (result *v1alpha1.AwsAmi, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awsamisResource, awsAmi), &v1alpha1.AwsAmi{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAmi), err
...
func (c *FakeAwsAmis) Update(awsAmi *v1alpha1.AwsAmi) (result *v1alpha1.AwsAmi, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awsamisResource, awsAmi), &v1alpha1.AwsAmi{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAmi), err
...
func (c *FakeAwsAmis) UpdateStatus(awsAmi *v1alpha1.AwsAmi) (*v1alpha1.AwsAmi, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awsamisResource, "status", awsAmi), &v1alpha1.AwsAmi{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAmi), err
...
func (c *FakeAwsAmis) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awsamisResource, name), &v1alpha1.AwsAmi{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeAwsAmis) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awsamisResource, listOptions)
...
func (c *FakeAwsAmis) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsAmi, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awsamisResource, name, pt, data, subresources...), &v1alpha1.AwsAmi{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAmi), err
