...
var awscloudwatchlogresourcepoliciesResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awscloudwatchlogresourcepolicies"}

var awscloudwatchlogresourcepoliciesKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsCloudwatchLogResourcePolicy"}
...
func (c *FakeAwsCloudwatchLogResourcePolicies) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsCloudwatchLogResourcePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awscloudwatchlogresourcepoliciesResource, name), &v1alpha1.AwsCloudwatchLogResourcePolicy{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsCloudwatchLogResourcePolicies) List(opts v1.ListOptions) (result *v1alpha1.AwsCloudwatchLogResourcePolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awscloudwatchlogresourcepoliciesResource, awscloudwatchlogresourcepoliciesKind, opts), &v1alpha1.AwsCloudwatchLogResourcePolicyList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsCloudwatchLogResourcePolicyList{ListMeta: obj.(*v1alpha1.AwsCloudwatchLogResourcePolicyList).ListMeta}
...
func (c *FakeAwsCloudwatchLogResourcePolicies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awscloudwatchlogresourcepoliciesResource, opts))
}
...
func (c *FakeAwsCloudwatchLogResourcePolicies) Create(awsCloudwatchLogResourcePolicy *v1alpha1.AwsCloudwatchLogResourcePolicy) (result *v1alpha1.AwsCloudwatchLogResourcePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awscloudwatchlogresourcepoliciesResource, awsCloudwatchLogResourcePolicy), &v1alpha1.AwsCloudwatchLogResourcePolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsCloudwatchLogResourcePolicy), err
...
func (c *FakeAwsCloudwatchLogResourcePolicies) Update(awsCloudwatchLogResourcePolicy *v1alpha1.AwsCloudwatchLogResourcePolicy) (result *v1alpha1.AwsCloudwatchLogResourcePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awscloudwatchlogresourcepoliciesResource, awsCloudwatchLogResourcePolicy), &v1alpha1.AwsCloudwatchLogResourcePolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsCloudwatchLogResourcePolicy), err
...
func (c *FakeAwsCloudwatchLogResourcePolicies) UpdateStatus(awsCloudwatchLogResourcePolicy *v1alpha1.AwsCloudwatchLogResourcePolicy) (*v1alpha1.AwsCloudwatchLogResourcePolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awscloudwatchlogresourcepoliciesResource, "status", awsCloudwatchLogResourcePolicy), &v1alpha1.AwsCloudwatchLogResourcePolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsCloudwatchLogResourcePolicy), err
...
func (c *FakeAwsCloudwatchLogResourcePolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awscloudwatchlogresourcepoliciesResource, name), &v1alpha1.AwsCloudwatchLogResourcePolicy{})
	return err
}
...
func (c *FakeAwsCloudwatchLogResourcePolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awscloudwatchlogresourcepoliciesResource, listOptions)
...
func (c *FakeAwsCloudwatchLogResourcePolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsCloudwatchLogResourcePolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awscloudwatchlogresourcepoliciesResource, name, pt, data, subresources...), &v1alpha1.AwsCloudwatchLogResourcePolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsCloudwatchLogResourcePolicy), err
