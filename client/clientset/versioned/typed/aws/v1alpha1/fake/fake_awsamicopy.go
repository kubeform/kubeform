...
var awsamicopiesResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awsamicopies"}

var awsamicopiesKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsAmiCopy"}
...
func (c *FakeAwsAmiCopies) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsAmiCopy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awsamicopiesResource, name), &v1alpha1.AwsAmiCopy{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsAmiCopies) List(opts v1.ListOptions) (result *v1alpha1.AwsAmiCopyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awsamicopiesResource, awsamicopiesKind, opts), &v1alpha1.AwsAmiCopyList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsAmiCopyList{ListMeta: obj.(*v1alpha1.AwsAmiCopyList).ListMeta}
...
func (c *FakeAwsAmiCopies) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awsamicopiesResource, opts))
}
...
func (c *FakeAwsAmiCopies) Create(awsAmiCopy *v1alpha1.AwsAmiCopy) (result *v1alpha1.AwsAmiCopy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awsamicopiesResource, awsAmiCopy), &v1alpha1.AwsAmiCopy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAmiCopy), err
...
func (c *FakeAwsAmiCopies) Update(awsAmiCopy *v1alpha1.AwsAmiCopy) (result *v1alpha1.AwsAmiCopy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awsamicopiesResource, awsAmiCopy), &v1alpha1.AwsAmiCopy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAmiCopy), err
...
func (c *FakeAwsAmiCopies) UpdateStatus(awsAmiCopy *v1alpha1.AwsAmiCopy) (*v1alpha1.AwsAmiCopy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awsamicopiesResource, "status", awsAmiCopy), &v1alpha1.AwsAmiCopy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAmiCopy), err
...
func (c *FakeAwsAmiCopies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awsamicopiesResource, name), &v1alpha1.AwsAmiCopy{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeAwsAmiCopies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awsamicopiesResource, listOptions)
...
func (c *FakeAwsAmiCopies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsAmiCopy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awsamicopiesResource, name, pt, data, subresources...), &v1alpha1.AwsAmiCopy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAmiCopy), err
