...
var awslaunchtemplatesResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awslaunchtemplates"}

var awslaunchtemplatesKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsLaunchTemplate"}
...
func (c *FakeAwsLaunchTemplates) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsLaunchTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awslaunchtemplatesResource, name), &v1alpha1.AwsLaunchTemplate{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsLaunchTemplates) List(opts v1.ListOptions) (result *v1alpha1.AwsLaunchTemplateList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awslaunchtemplatesResource, awslaunchtemplatesKind, opts), &v1alpha1.AwsLaunchTemplateList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsLaunchTemplateList{ListMeta: obj.(*v1alpha1.AwsLaunchTemplateList).ListMeta}
...
func (c *FakeAwsLaunchTemplates) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awslaunchtemplatesResource, opts))
}
...
func (c *FakeAwsLaunchTemplates) Create(awsLaunchTemplate *v1alpha1.AwsLaunchTemplate) (result *v1alpha1.AwsLaunchTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awslaunchtemplatesResource, awsLaunchTemplate), &v1alpha1.AwsLaunchTemplate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsLaunchTemplate), err
...
func (c *FakeAwsLaunchTemplates) Update(awsLaunchTemplate *v1alpha1.AwsLaunchTemplate) (result *v1alpha1.AwsLaunchTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awslaunchtemplatesResource, awsLaunchTemplate), &v1alpha1.AwsLaunchTemplate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsLaunchTemplate), err
...
func (c *FakeAwsLaunchTemplates) UpdateStatus(awsLaunchTemplate *v1alpha1.AwsLaunchTemplate) (*v1alpha1.AwsLaunchTemplate, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awslaunchtemplatesResource, "status", awsLaunchTemplate), &v1alpha1.AwsLaunchTemplate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsLaunchTemplate), err
...
func (c *FakeAwsLaunchTemplates) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awslaunchtemplatesResource, name), &v1alpha1.AwsLaunchTemplate{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeAwsLaunchTemplates) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awslaunchtemplatesResource, listOptions)
...
func (c *FakeAwsLaunchTemplates) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsLaunchTemplate, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awslaunchtemplatesResource, name, pt, data, subresources...), &v1alpha1.AwsLaunchTemplate{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsLaunchTemplate), err
