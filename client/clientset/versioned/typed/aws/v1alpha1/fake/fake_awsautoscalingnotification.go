...
var awsautoscalingnotificationsResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awsautoscalingnotifications"}

var awsautoscalingnotificationsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsAutoscalingNotification"}
...
func (c *FakeAwsAutoscalingNotifications) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsAutoscalingNotification, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awsautoscalingnotificationsResource, name), &v1alpha1.AwsAutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsAutoscalingNotifications) List(opts v1.ListOptions) (result *v1alpha1.AwsAutoscalingNotificationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awsautoscalingnotificationsResource, awsautoscalingnotificationsKind, opts), &v1alpha1.AwsAutoscalingNotificationList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsAutoscalingNotificationList{ListMeta: obj.(*v1alpha1.AwsAutoscalingNotificationList).ListMeta}
...
func (c *FakeAwsAutoscalingNotifications) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awsautoscalingnotificationsResource, opts))
}
...
func (c *FakeAwsAutoscalingNotifications) Create(awsAutoscalingNotification *v1alpha1.AwsAutoscalingNotification) (result *v1alpha1.AwsAutoscalingNotification, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awsautoscalingnotificationsResource, awsAutoscalingNotification), &v1alpha1.AwsAutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAutoscalingNotification), err
...
func (c *FakeAwsAutoscalingNotifications) Update(awsAutoscalingNotification *v1alpha1.AwsAutoscalingNotification) (result *v1alpha1.AwsAutoscalingNotification, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awsautoscalingnotificationsResource, awsAutoscalingNotification), &v1alpha1.AwsAutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAutoscalingNotification), err
...
func (c *FakeAwsAutoscalingNotifications) UpdateStatus(awsAutoscalingNotification *v1alpha1.AwsAutoscalingNotification) (*v1alpha1.AwsAutoscalingNotification, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awsautoscalingnotificationsResource, "status", awsAutoscalingNotification), &v1alpha1.AwsAutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAutoscalingNotification), err
...
func (c *FakeAwsAutoscalingNotifications) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awsautoscalingnotificationsResource, name), &v1alpha1.AwsAutoscalingNotification{})
	return err
}
...
func (c *FakeAwsAutoscalingNotifications) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awsautoscalingnotificationsResource, listOptions)
...
func (c *FakeAwsAutoscalingNotifications) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsAutoscalingNotification, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awsautoscalingnotificationsResource, name, pt, data, subresources...), &v1alpha1.AwsAutoscalingNotification{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAutoscalingNotification), err
