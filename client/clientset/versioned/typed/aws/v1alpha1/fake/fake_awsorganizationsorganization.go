...
var awsorganizationsorganizationsResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awsorganizationsorganizations"}

var awsorganizationsorganizationsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsOrganizationsOrganization"}
...
func (c *FakeAwsOrganizationsOrganizations) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsOrganizationsOrganization, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awsorganizationsorganizationsResource, name), &v1alpha1.AwsOrganizationsOrganization{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsOrganizationsOrganizations) List(opts v1.ListOptions) (result *v1alpha1.AwsOrganizationsOrganizationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awsorganizationsorganizationsResource, awsorganizationsorganizationsKind, opts), &v1alpha1.AwsOrganizationsOrganizationList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsOrganizationsOrganizationList{ListMeta: obj.(*v1alpha1.AwsOrganizationsOrganizationList).ListMeta}
...
func (c *FakeAwsOrganizationsOrganizations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awsorganizationsorganizationsResource, opts))
}
...
func (c *FakeAwsOrganizationsOrganizations) Create(awsOrganizationsOrganization *v1alpha1.AwsOrganizationsOrganization) (result *v1alpha1.AwsOrganizationsOrganization, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awsorganizationsorganizationsResource, awsOrganizationsOrganization), &v1alpha1.AwsOrganizationsOrganization{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsOrganizationsOrganization), err
...
func (c *FakeAwsOrganizationsOrganizations) Update(awsOrganizationsOrganization *v1alpha1.AwsOrganizationsOrganization) (result *v1alpha1.AwsOrganizationsOrganization, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awsorganizationsorganizationsResource, awsOrganizationsOrganization), &v1alpha1.AwsOrganizationsOrganization{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsOrganizationsOrganization), err
...
func (c *FakeAwsOrganizationsOrganizations) UpdateStatus(awsOrganizationsOrganization *v1alpha1.AwsOrganizationsOrganization) (*v1alpha1.AwsOrganizationsOrganization, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awsorganizationsorganizationsResource, "status", awsOrganizationsOrganization), &v1alpha1.AwsOrganizationsOrganization{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsOrganizationsOrganization), err
...
func (c *FakeAwsOrganizationsOrganizations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awsorganizationsorganizationsResource, name), &v1alpha1.AwsOrganizationsOrganization{})
	return err
}
...
func (c *FakeAwsOrganizationsOrganizations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awsorganizationsorganizationsResource, listOptions)
...
func (c *FakeAwsOrganizationsOrganizations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsOrganizationsOrganization, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awsorganizationsorganizationsResource, name, pt, data, subresources...), &v1alpha1.AwsOrganizationsOrganization{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsOrganizationsOrganization), err
