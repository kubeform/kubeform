...
var awsservicediscoveryservicesResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awsservicediscoveryservices"}

var awsservicediscoveryservicesKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsServiceDiscoveryService"}
...
func (c *FakeAwsServiceDiscoveryServices) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsServiceDiscoveryService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awsservicediscoveryservicesResource, name), &v1alpha1.AwsServiceDiscoveryService{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsServiceDiscoveryServices) List(opts v1.ListOptions) (result *v1alpha1.AwsServiceDiscoveryServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awsservicediscoveryservicesResource, awsservicediscoveryservicesKind, opts), &v1alpha1.AwsServiceDiscoveryServiceList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsServiceDiscoveryServiceList{ListMeta: obj.(*v1alpha1.AwsServiceDiscoveryServiceList).ListMeta}
...
func (c *FakeAwsServiceDiscoveryServices) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awsservicediscoveryservicesResource, opts))
}
...
func (c *FakeAwsServiceDiscoveryServices) Create(awsServiceDiscoveryService *v1alpha1.AwsServiceDiscoveryService) (result *v1alpha1.AwsServiceDiscoveryService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awsservicediscoveryservicesResource, awsServiceDiscoveryService), &v1alpha1.AwsServiceDiscoveryService{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsServiceDiscoveryService), err
...
func (c *FakeAwsServiceDiscoveryServices) Update(awsServiceDiscoveryService *v1alpha1.AwsServiceDiscoveryService) (result *v1alpha1.AwsServiceDiscoveryService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awsservicediscoveryservicesResource, awsServiceDiscoveryService), &v1alpha1.AwsServiceDiscoveryService{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsServiceDiscoveryService), err
...
func (c *FakeAwsServiceDiscoveryServices) UpdateStatus(awsServiceDiscoveryService *v1alpha1.AwsServiceDiscoveryService) (*v1alpha1.AwsServiceDiscoveryService, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awsservicediscoveryservicesResource, "status", awsServiceDiscoveryService), &v1alpha1.AwsServiceDiscoveryService{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsServiceDiscoveryService), err
...
func (c *FakeAwsServiceDiscoveryServices) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awsservicediscoveryservicesResource, name), &v1alpha1.AwsServiceDiscoveryService{})
	return err
}
...
func (c *FakeAwsServiceDiscoveryServices) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awsservicediscoveryservicesResource, listOptions)
...
func (c *FakeAwsServiceDiscoveryServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsServiceDiscoveryService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awsservicediscoveryservicesResource, name, pt, data, subresources...), &v1alpha1.AwsServiceDiscoveryService{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsServiceDiscoveryService), err
