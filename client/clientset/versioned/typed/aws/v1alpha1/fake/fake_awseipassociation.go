...
var awseipassociationsResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awseipassociations"}

var awseipassociationsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsEipAssociation"}
...
func (c *FakeAwsEipAssociations) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsEipAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awseipassociationsResource, name), &v1alpha1.AwsEipAssociation{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsEipAssociations) List(opts v1.ListOptions) (result *v1alpha1.AwsEipAssociationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awseipassociationsResource, awseipassociationsKind, opts), &v1alpha1.AwsEipAssociationList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsEipAssociationList{ListMeta: obj.(*v1alpha1.AwsEipAssociationList).ListMeta}
...
func (c *FakeAwsEipAssociations) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awseipassociationsResource, opts))
}
...
func (c *FakeAwsEipAssociations) Create(awsEipAssociation *v1alpha1.AwsEipAssociation) (result *v1alpha1.AwsEipAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awseipassociationsResource, awsEipAssociation), &v1alpha1.AwsEipAssociation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsEipAssociation), err
...
func (c *FakeAwsEipAssociations) Update(awsEipAssociation *v1alpha1.AwsEipAssociation) (result *v1alpha1.AwsEipAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awseipassociationsResource, awsEipAssociation), &v1alpha1.AwsEipAssociation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsEipAssociation), err
...
func (c *FakeAwsEipAssociations) UpdateStatus(awsEipAssociation *v1alpha1.AwsEipAssociation) (*v1alpha1.AwsEipAssociation, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awseipassociationsResource, "status", awsEipAssociation), &v1alpha1.AwsEipAssociation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsEipAssociation), err
...
func (c *FakeAwsEipAssociations) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awseipassociationsResource, name), &v1alpha1.AwsEipAssociation{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeAwsEipAssociations) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awseipassociationsResource, listOptions)
...
func (c *FakeAwsEipAssociations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsEipAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awseipassociationsResource, name, pt, data, subresources...), &v1alpha1.AwsEipAssociation{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsEipAssociation), err
