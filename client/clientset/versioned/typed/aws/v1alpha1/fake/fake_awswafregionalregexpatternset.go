...
var awswafregionalregexpatternsetsResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awswafregionalregexpatternsets"}

var awswafregionalregexpatternsetsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsWafregionalRegexPatternSet"}
...
func (c *FakeAwsWafregionalRegexPatternSets) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsWafregionalRegexPatternSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awswafregionalregexpatternsetsResource, name), &v1alpha1.AwsWafregionalRegexPatternSet{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsWafregionalRegexPatternSets) List(opts v1.ListOptions) (result *v1alpha1.AwsWafregionalRegexPatternSetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awswafregionalregexpatternsetsResource, awswafregionalregexpatternsetsKind, opts), &v1alpha1.AwsWafregionalRegexPatternSetList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsWafregionalRegexPatternSetList{ListMeta: obj.(*v1alpha1.AwsWafregionalRegexPatternSetList).ListMeta}
...
func (c *FakeAwsWafregionalRegexPatternSets) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awswafregionalregexpatternsetsResource, opts))
}
...
func (c *FakeAwsWafregionalRegexPatternSets) Create(awsWafregionalRegexPatternSet *v1alpha1.AwsWafregionalRegexPatternSet) (result *v1alpha1.AwsWafregionalRegexPatternSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awswafregionalregexpatternsetsResource, awsWafregionalRegexPatternSet), &v1alpha1.AwsWafregionalRegexPatternSet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsWafregionalRegexPatternSet), err
...
func (c *FakeAwsWafregionalRegexPatternSets) Update(awsWafregionalRegexPatternSet *v1alpha1.AwsWafregionalRegexPatternSet) (result *v1alpha1.AwsWafregionalRegexPatternSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awswafregionalregexpatternsetsResource, awsWafregionalRegexPatternSet), &v1alpha1.AwsWafregionalRegexPatternSet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsWafregionalRegexPatternSet), err
...
func (c *FakeAwsWafregionalRegexPatternSets) UpdateStatus(awsWafregionalRegexPatternSet *v1alpha1.AwsWafregionalRegexPatternSet) (*v1alpha1.AwsWafregionalRegexPatternSet, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awswafregionalregexpatternsetsResource, "status", awsWafregionalRegexPatternSet), &v1alpha1.AwsWafregionalRegexPatternSet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsWafregionalRegexPatternSet), err
...
func (c *FakeAwsWafregionalRegexPatternSets) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awswafregionalregexpatternsetsResource, name), &v1alpha1.AwsWafregionalRegexPatternSet{})
	return err
}
...
func (c *FakeAwsWafregionalRegexPatternSets) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awswafregionalregexpatternsetsResource, listOptions)
...
func (c *FakeAwsWafregionalRegexPatternSets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsWafregionalRegexPatternSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awswafregionalregexpatternsetsResource, name, pt, data, subresources...), &v1alpha1.AwsWafregionalRegexPatternSet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsWafregionalRegexPatternSet), err
