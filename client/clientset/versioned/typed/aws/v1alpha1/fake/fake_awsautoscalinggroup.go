...
var awsautoscalinggroupsResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awsautoscalinggroups"}

var awsautoscalinggroupsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsAutoscalingGroup"}
...
func (c *FakeAwsAutoscalingGroups) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsAutoscalingGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awsautoscalinggroupsResource, name), &v1alpha1.AwsAutoscalingGroup{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsAutoscalingGroups) List(opts v1.ListOptions) (result *v1alpha1.AwsAutoscalingGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awsautoscalinggroupsResource, awsautoscalinggroupsKind, opts), &v1alpha1.AwsAutoscalingGroupList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsAutoscalingGroupList{ListMeta: obj.(*v1alpha1.AwsAutoscalingGroupList).ListMeta}
...
func (c *FakeAwsAutoscalingGroups) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awsautoscalinggroupsResource, opts))
}
...
func (c *FakeAwsAutoscalingGroups) Create(awsAutoscalingGroup *v1alpha1.AwsAutoscalingGroup) (result *v1alpha1.AwsAutoscalingGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awsautoscalinggroupsResource, awsAutoscalingGroup), &v1alpha1.AwsAutoscalingGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAutoscalingGroup), err
...
func (c *FakeAwsAutoscalingGroups) Update(awsAutoscalingGroup *v1alpha1.AwsAutoscalingGroup) (result *v1alpha1.AwsAutoscalingGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awsautoscalinggroupsResource, awsAutoscalingGroup), &v1alpha1.AwsAutoscalingGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAutoscalingGroup), err
...
func (c *FakeAwsAutoscalingGroups) UpdateStatus(awsAutoscalingGroup *v1alpha1.AwsAutoscalingGroup) (*v1alpha1.AwsAutoscalingGroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awsautoscalinggroupsResource, "status", awsAutoscalingGroup), &v1alpha1.AwsAutoscalingGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAutoscalingGroup), err
...
func (c *FakeAwsAutoscalingGroups) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awsautoscalinggroupsResource, name), &v1alpha1.AwsAutoscalingGroup{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeAwsAutoscalingGroups) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awsautoscalinggroupsResource, listOptions)
...
func (c *FakeAwsAutoscalingGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsAutoscalingGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awsautoscalinggroupsResource, name, pt, data, subresources...), &v1alpha1.AwsAutoscalingGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsAutoscalingGroup), err
