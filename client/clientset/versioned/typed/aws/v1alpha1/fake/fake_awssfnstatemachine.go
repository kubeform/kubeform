...
var awssfnstatemachinesResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awssfnstatemachines"}

var awssfnstatemachinesKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsSfnStateMachine"}
...
func (c *FakeAwsSfnStateMachines) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSfnStateMachine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awssfnstatemachinesResource, name), &v1alpha1.AwsSfnStateMachine{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsSfnStateMachines) List(opts v1.ListOptions) (result *v1alpha1.AwsSfnStateMachineList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awssfnstatemachinesResource, awssfnstatemachinesKind, opts), &v1alpha1.AwsSfnStateMachineList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsSfnStateMachineList{ListMeta: obj.(*v1alpha1.AwsSfnStateMachineList).ListMeta}
...
func (c *FakeAwsSfnStateMachines) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awssfnstatemachinesResource, opts))
}
...
func (c *FakeAwsSfnStateMachines) Create(awsSfnStateMachine *v1alpha1.AwsSfnStateMachine) (result *v1alpha1.AwsSfnStateMachine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awssfnstatemachinesResource, awsSfnStateMachine), &v1alpha1.AwsSfnStateMachine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsSfnStateMachine), err
...
func (c *FakeAwsSfnStateMachines) Update(awsSfnStateMachine *v1alpha1.AwsSfnStateMachine) (result *v1alpha1.AwsSfnStateMachine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awssfnstatemachinesResource, awsSfnStateMachine), &v1alpha1.AwsSfnStateMachine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsSfnStateMachine), err
...
func (c *FakeAwsSfnStateMachines) UpdateStatus(awsSfnStateMachine *v1alpha1.AwsSfnStateMachine) (*v1alpha1.AwsSfnStateMachine, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awssfnstatemachinesResource, "status", awsSfnStateMachine), &v1alpha1.AwsSfnStateMachine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsSfnStateMachine), err
...
func (c *FakeAwsSfnStateMachines) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awssfnstatemachinesResource, name), &v1alpha1.AwsSfnStateMachine{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeAwsSfnStateMachines) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awssfnstatemachinesResource, listOptions)
...
func (c *FakeAwsSfnStateMachines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSfnStateMachine, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awssfnstatemachinesResource, name, pt, data, subresources...), &v1alpha1.AwsSfnStateMachine{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsSfnStateMachine), err
