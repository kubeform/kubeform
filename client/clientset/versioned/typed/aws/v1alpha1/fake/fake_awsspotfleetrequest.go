...
var awsspotfleetrequestsResource = schema.GroupVersionResource{Group: "aws.kubeform.com", Version: "v1alpha1", Resource: "awsspotfleetrequests"}

var awsspotfleetrequestsKind = schema.GroupVersionKind{Group: "aws.kubeform.com", Version: "v1alpha1", Kind: "AwsSpotFleetRequest"}
...
func (c *FakeAwsSpotFleetRequests) Get(name string, options v1.GetOptions) (result *v1alpha1.AwsSpotFleetRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(awsspotfleetrequestsResource, name), &v1alpha1.AwsSpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeAwsSpotFleetRequests) List(opts v1.ListOptions) (result *v1alpha1.AwsSpotFleetRequestList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(awsspotfleetrequestsResource, awsspotfleetrequestsKind, opts), &v1alpha1.AwsSpotFleetRequestList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.AwsSpotFleetRequestList{ListMeta: obj.(*v1alpha1.AwsSpotFleetRequestList).ListMeta}
...
func (c *FakeAwsSpotFleetRequests) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(awsspotfleetrequestsResource, opts))
}
...
func (c *FakeAwsSpotFleetRequests) Create(awsSpotFleetRequest *v1alpha1.AwsSpotFleetRequest) (result *v1alpha1.AwsSpotFleetRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(awsspotfleetrequestsResource, awsSpotFleetRequest), &v1alpha1.AwsSpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsSpotFleetRequest), err
...
func (c *FakeAwsSpotFleetRequests) Update(awsSpotFleetRequest *v1alpha1.AwsSpotFleetRequest) (result *v1alpha1.AwsSpotFleetRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(awsspotfleetrequestsResource, awsSpotFleetRequest), &v1alpha1.AwsSpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsSpotFleetRequest), err
...
func (c *FakeAwsSpotFleetRequests) UpdateStatus(awsSpotFleetRequest *v1alpha1.AwsSpotFleetRequest) (*v1alpha1.AwsSpotFleetRequest, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(awsspotfleetrequestsResource, "status", awsSpotFleetRequest), &v1alpha1.AwsSpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsSpotFleetRequest), err
...
func (c *FakeAwsSpotFleetRequests) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(awsspotfleetrequestsResource, name), &v1alpha1.AwsSpotFleetRequest{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeAwsSpotFleetRequests) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(awsspotfleetrequestsResource, listOptions)
...
func (c *FakeAwsSpotFleetRequests) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.AwsSpotFleetRequest, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(awsspotfleetrequestsResource, name, pt, data, subresources...), &v1alpha1.AwsSpotFleetRequest{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AwsSpotFleetRequest), err
