...
type AwsDynamodbGlobalTablesGetter interface {
	AwsDynamodbGlobalTables() AwsDynamodbGlobalTableInterface
}
...
type AwsDynamodbGlobalTableInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsDynamodbGlobalTable) (*v1alpha1.AwsDynamodbGlobalTable, error)
...
func newAwsDynamodbGlobalTables(c *AwsV1alpha1Client) *awsDynamodbGlobalTables {
...
func (c *awsDynamodbGlobalTables) UpdateStatus(awsDynamodbGlobalTable *v1alpha1.AwsDynamodbGlobalTable) (result *v1alpha1.AwsDynamodbGlobalTable, err error) {
	result = &v1alpha1.AwsDynamodbGlobalTable{}
	err = c.client.Put().
		Resource("awsdynamodbglobaltables").
		Name(awsDynamodbGlobalTable.Name).
