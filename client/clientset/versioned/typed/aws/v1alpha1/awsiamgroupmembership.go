...
type AwsIamGroupMembershipsGetter interface {
	AwsIamGroupMemberships() AwsIamGroupMembershipInterface
}
...
type AwsIamGroupMembershipInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsIamGroupMembership) (*v1alpha1.AwsIamGroupMembership, error)
...
func newAwsIamGroupMemberships(c *AwsV1alpha1Client) *awsIamGroupMemberships {
...
func (c *awsIamGroupMemberships) UpdateStatus(awsIamGroupMembership *v1alpha1.AwsIamGroupMembership) (result *v1alpha1.AwsIamGroupMembership, err error) {
	result = &v1alpha1.AwsIamGroupMembership{}
	err = c.client.Put().
		Resource("awsiamgroupmemberships").
		Name(awsIamGroupMembership.Name).
