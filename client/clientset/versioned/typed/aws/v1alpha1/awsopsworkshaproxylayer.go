...
type AwsOpsworksHaproxyLayersGetter interface {
	AwsOpsworksHaproxyLayers() AwsOpsworksHaproxyLayerInterface
}
...
type AwsOpsworksHaproxyLayerInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsOpsworksHaproxyLayer) (*v1alpha1.AwsOpsworksHaproxyLayer, error)
...
func newAwsOpsworksHaproxyLayers(c *AwsV1alpha1Client) *awsOpsworksHaproxyLayers {
...
func (c *awsOpsworksHaproxyLayers) UpdateStatus(awsOpsworksHaproxyLayer *v1alpha1.AwsOpsworksHaproxyLayer) (result *v1alpha1.AwsOpsworksHaproxyLayer, err error) {
	result = &v1alpha1.AwsOpsworksHaproxyLayer{}
	err = c.client.Put().
		Resource("awsopsworkshaproxylayers").
		Name(awsOpsworksHaproxyLayer.Name).
