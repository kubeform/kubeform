...
type AwsRedshiftSubnetGroupsGetter interface {
	AwsRedshiftSubnetGroups() AwsRedshiftSubnetGroupInterface
}
...
type AwsRedshiftSubnetGroupInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsRedshiftSubnetGroup) (*v1alpha1.AwsRedshiftSubnetGroup, error)
...
func newAwsRedshiftSubnetGroups(c *AwsV1alpha1Client) *awsRedshiftSubnetGroups {
...
func (c *awsRedshiftSubnetGroups) UpdateStatus(awsRedshiftSubnetGroup *v1alpha1.AwsRedshiftSubnetGroup) (result *v1alpha1.AwsRedshiftSubnetGroup, err error) {
	result = &v1alpha1.AwsRedshiftSubnetGroup{}
	err = c.client.Put().
		Resource("awsredshiftsubnetgroups").
		Name(awsRedshiftSubnetGroup.Name).
