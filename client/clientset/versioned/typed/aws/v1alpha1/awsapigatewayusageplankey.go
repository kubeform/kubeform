...
type AwsApiGatewayUsagePlanKeysGetter interface {
	AwsApiGatewayUsagePlanKeys() AwsApiGatewayUsagePlanKeyInterface
}
...
type AwsApiGatewayUsagePlanKeyInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsApiGatewayUsagePlanKey) (*v1alpha1.AwsApiGatewayUsagePlanKey, error)
...
func newAwsApiGatewayUsagePlanKeys(c *AwsV1alpha1Client) *awsApiGatewayUsagePlanKeys {
...
func (c *awsApiGatewayUsagePlanKeys) UpdateStatus(awsApiGatewayUsagePlanKey *v1alpha1.AwsApiGatewayUsagePlanKey) (result *v1alpha1.AwsApiGatewayUsagePlanKey, err error) {
	result = &v1alpha1.AwsApiGatewayUsagePlanKey{}
	err = c.client.Put().
		Resource("awsapigatewayusageplankeys").
		Name(awsApiGatewayUsagePlanKey.Name).
