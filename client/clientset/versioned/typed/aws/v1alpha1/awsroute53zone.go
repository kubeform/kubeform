...
type AwsRoute53ZonesGetter interface {
	AwsRoute53Zones() AwsRoute53ZoneInterface
}
...
type AwsRoute53ZoneInterface interface {
	...
	UpdateStatus(*v1alpha1.AwsRoute53Zone) (*v1alpha1.AwsRoute53Zone, error)
...
func newAwsRoute53Zones(c *AwsV1alpha1Client) *awsRoute53Zones {
...
func (c *awsRoute53Zones) UpdateStatus(awsRoute53Zone *v1alpha1.AwsRoute53Zone) (result *v1alpha1.AwsRoute53Zone, err error) {
	result = &v1alpha1.AwsRoute53Zone{}
	err = c.client.Put().
		Resource("awsroute53zones").
		Name(awsRoute53Zone.Name).
