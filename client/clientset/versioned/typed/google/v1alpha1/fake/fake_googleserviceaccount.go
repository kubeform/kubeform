...
var googleserviceaccountsResource = schema.GroupVersionResource{Group: "google.kubeform.com", Version: "v1alpha1", Resource: "googleserviceaccounts"}

var googleserviceaccountsKind = schema.GroupVersionKind{Group: "google.kubeform.com", Version: "v1alpha1", Kind: "GoogleServiceAccount"}
...
func (c *FakeGoogleServiceAccounts) Get(name string, options v1.GetOptions) (result *v1alpha1.GoogleServiceAccount, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(googleserviceaccountsResource, name), &v1alpha1.GoogleServiceAccount{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeGoogleServiceAccounts) List(opts v1.ListOptions) (result *v1alpha1.GoogleServiceAccountList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(googleserviceaccountsResource, googleserviceaccountsKind, opts), &v1alpha1.GoogleServiceAccountList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeGoogleServiceAccounts) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(googleserviceaccountsResource, opts))
}
...
func (c *FakeGoogleServiceAccounts) Create(googleServiceAccount *v1alpha1.GoogleServiceAccount) (result *v1alpha1.GoogleServiceAccount, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(googleserviceaccountsResource, googleServiceAccount), &v1alpha1.GoogleServiceAccount{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GoogleServiceAccount), err
...
func (c *FakeGoogleServiceAccounts) Update(googleServiceAccount *v1alpha1.GoogleServiceAccount) (result *v1alpha1.GoogleServiceAccount, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(googleserviceaccountsResource, googleServiceAccount), &v1alpha1.GoogleServiceAccount{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GoogleServiceAccount), err
...
func (c *FakeGoogleServiceAccounts) UpdateStatus(googleServiceAccount *v1alpha1.GoogleServiceAccount) (*v1alpha1.GoogleServiceAccount, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(googleserviceaccountsResource, "status", googleServiceAccount), &v1alpha1.GoogleServiceAccount{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GoogleServiceAccount), err
...
func (c *FakeGoogleServiceAccounts) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(googleserviceaccountsResource, name), &v1alpha1.GoogleServiceAccount{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeGoogleServiceAccounts) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(googleserviceaccountsResource, listOptions)
...
func (c *FakeGoogleServiceAccounts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.GoogleServiceAccount, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(googleserviceaccountsResource, name, pt, data, subresources...), &v1alpha1.GoogleServiceAccount{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.GoogleServiceAccount), err
