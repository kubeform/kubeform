...
type AwsApiGatewayDeploymentLister interface {
	...
	// Get retrieves the AwsApiGatewayDeployment from the index for a given name.
...
// Get retrieves the AwsApiGatewayDeployment from the index for a given name.
func (s *awsApiGatewayDeploymentLister) Get(name string) (*v1alpha1.AwsApiGatewayDeployment, error) {
