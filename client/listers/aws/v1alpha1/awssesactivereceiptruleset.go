...
type AwsSesActiveReceiptRuleSetLister interface {
	...
	// Get retrieves the AwsSesActiveReceiptRuleSet from the index for a given name.
...
// Get retrieves the AwsSesActiveReceiptRuleSet from the index for a given name.
func (s *awsSesActiveReceiptRuleSetLister) Get(name string) (*v1alpha1.AwsSesActiveReceiptRuleSet, error) {
