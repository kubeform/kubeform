...
type AwsIamRolePolicyAttachmentLister interface {
	...
	// Get retrieves the AwsIamRolePolicyAttachment from the index for a given name.
...
// Get retrieves the AwsIamRolePolicyAttachment from the index for a given name.
func (s *awsIamRolePolicyAttachmentLister) Get(name string) (*v1alpha1.AwsIamRolePolicyAttachment, error) {
