...
type AwsLaunchConfigurationLister interface {
	...
	// Get retrieves the AwsLaunchConfiguration from the index for a given name.
...
// Get retrieves the AwsLaunchConfiguration from the index for a given name.
func (s *awsLaunchConfigurationLister) Get(name string) (*v1alpha1.AwsLaunchConfiguration, error) {
