...
type AwsVpcEndpointServiceLister interface {
	...
	// Get retrieves the AwsVpcEndpointService from the index for a given name.
...
// Get retrieves the AwsVpcEndpointService from the index for a given name.
func (s *awsVpcEndpointServiceLister) Get(name string) (*v1alpha1.AwsVpcEndpointService, error) {
