...
type AwsCodedeployDeploymentConfigLister interface {
	...
	// Get retrieves the AwsCodedeployDeploymentConfig from the index for a given name.
...
// Get retrieves the AwsCodedeployDeploymentConfig from the index for a given name.
func (s *awsCodedeployDeploymentConfigLister) Get(name string) (*v1alpha1.AwsCodedeployDeploymentConfig, error) {
