...
type AwsWafRegexPatternSetLister interface {
	...
	// Get retrieves the AwsWafRegexPatternSet from the index for a given name.
...
// Get retrieves the AwsWafRegexPatternSet from the index for a given name.
func (s *awsWafRegexPatternSetLister) Get(name string) (*v1alpha1.AwsWafRegexPatternSet, error) {
