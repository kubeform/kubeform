...
type AwsIamServerCertificateLister interface {
	...
	// Get retrieves the AwsIamServerCertificate from the index for a given name.
...
// Get retrieves the AwsIamServerCertificate from the index for a given name.
func (s *awsIamServerCertificateLister) Get(name string) (*v1alpha1.AwsIamServerCertificate, error) {
