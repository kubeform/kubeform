...
type AwsWafregionalXssMatchSetLister interface {
	...
	// Get retrieves the AwsWafregionalXssMatchSet from the index for a given name.
...
// Get retrieves the AwsWafregionalXssMatchSet from the index for a given name.
func (s *awsWafregionalXssMatchSetLister) Get(name string) (*v1alpha1.AwsWafregionalXssMatchSet, error) {
