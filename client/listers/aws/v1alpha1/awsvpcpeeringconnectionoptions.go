...
type AwsVpcPeeringConnectionOptionsLister interface {
	...
	// Get retrieves the AwsVpcPeeringConnectionOptions from the index for a given name.
...
// Get retrieves the AwsVpcPeeringConnectionOptions from the index for a given name.
func (s *awsVpcPeeringConnectionOptionsLister) Get(name string) (*v1alpha1.AwsVpcPeeringConnectionOptions, error) {
