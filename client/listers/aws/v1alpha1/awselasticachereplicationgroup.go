...
type AwsElasticacheReplicationGroupLister interface {
	...
	// Get retrieves the AwsElasticacheReplicationGroup from the index for a given name.
...
// Get retrieves the AwsElasticacheReplicationGroup from the index for a given name.
func (s *awsElasticacheReplicationGroupLister) Get(name string) (*v1alpha1.AwsElasticacheReplicationGroup, error) {
