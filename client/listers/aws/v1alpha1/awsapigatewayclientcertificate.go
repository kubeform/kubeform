...
type AwsApiGatewayClientCertificateLister interface {
	...
	// Get retrieves the AwsApiGatewayClientCertificate from the index for a given name.
...
// Get retrieves the AwsApiGatewayClientCertificate from the index for a given name.
func (s *awsApiGatewayClientCertificateLister) Get(name string) (*v1alpha1.AwsApiGatewayClientCertificate, error) {
