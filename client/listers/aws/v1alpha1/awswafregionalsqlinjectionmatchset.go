...
type AwsWafregionalSqlInjectionMatchSetLister interface {
	...
	// Get retrieves the AwsWafregionalSqlInjectionMatchSet from the index for a given name.
...
// Get retrieves the AwsWafregionalSqlInjectionMatchSet from the index for a given name.
func (s *awsWafregionalSqlInjectionMatchSetLister) Get(name string) (*v1alpha1.AwsWafregionalSqlInjectionMatchSet, error) {
