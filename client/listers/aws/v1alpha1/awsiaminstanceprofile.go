...
type AwsIamInstanceProfileLister interface {
	...
	// Get retrieves the AwsIamInstanceProfile from the index for a given name.
...
// Get retrieves the AwsIamInstanceProfile from the index for a given name.
func (s *awsIamInstanceProfileLister) Get(name string) (*v1alpha1.AwsIamInstanceProfile, error) {
