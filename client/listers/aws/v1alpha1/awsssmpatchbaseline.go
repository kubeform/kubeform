...
type AwsSsmPatchBaselineLister interface {
	...
	// Get retrieves the AwsSsmPatchBaseline from the index for a given name.
...
// Get retrieves the AwsSsmPatchBaseline from the index for a given name.
func (s *awsSsmPatchBaselineLister) Get(name string) (*v1alpha1.AwsSsmPatchBaseline, error) {
