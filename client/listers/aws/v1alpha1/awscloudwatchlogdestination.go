...
type AwsCloudwatchLogDestinationLister interface {
	...
	// Get retrieves the AwsCloudwatchLogDestination from the index for a given name.
...
// Get retrieves the AwsCloudwatchLogDestination from the index for a given name.
func (s *awsCloudwatchLogDestinationLister) Get(name string) (*v1alpha1.AwsCloudwatchLogDestination, error) {
