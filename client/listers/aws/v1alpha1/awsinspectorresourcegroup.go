...
type AwsInspectorResourceGroupLister interface {
	...
	// Get retrieves the AwsInspectorResourceGroup from the index for a given name.
...
// Get retrieves the AwsInspectorResourceGroup from the index for a given name.
func (s *awsInspectorResourceGroupLister) Get(name string) (*v1alpha1.AwsInspectorResourceGroup, error) {
