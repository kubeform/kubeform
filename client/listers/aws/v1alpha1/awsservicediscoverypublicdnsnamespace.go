...
type AwsServiceDiscoveryPublicDnsNamespaceLister interface {
	...
	// Get retrieves the AwsServiceDiscoveryPublicDnsNamespace from the index for a given name.
...
// Get retrieves the AwsServiceDiscoveryPublicDnsNamespace from the index for a given name.
func (s *awsServiceDiscoveryPublicDnsNamespaceLister) Get(name string) (*v1alpha1.AwsServiceDiscoveryPublicDnsNamespace, error) {
