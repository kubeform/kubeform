...
type AwsSecurityGroupRuleLister interface {
	...
	// Get retrieves the AwsSecurityGroupRule from the index for a given name.
...
// Get retrieves the AwsSecurityGroupRule from the index for a given name.
func (s *awsSecurityGroupRuleLister) Get(name string) (*v1alpha1.AwsSecurityGroupRule, error) {
