...
type AwsOrganizationsAccountLister interface {
	...
	// Get retrieves the AwsOrganizationsAccount from the index for a given name.
...
// Get retrieves the AwsOrganizationsAccount from the index for a given name.
func (s *awsOrganizationsAccountLister) Get(name string) (*v1alpha1.AwsOrganizationsAccount, error) {
