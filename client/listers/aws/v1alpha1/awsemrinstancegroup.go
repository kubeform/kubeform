...
type AwsEmrInstanceGroupLister interface {
	...
	// Get retrieves the AwsEmrInstanceGroup from the index for a given name.
...
// Get retrieves the AwsEmrInstanceGroup from the index for a given name.
func (s *awsEmrInstanceGroupLister) Get(name string) (*v1alpha1.AwsEmrInstanceGroup, error) {
