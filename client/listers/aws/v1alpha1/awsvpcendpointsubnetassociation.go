...
type AwsVpcEndpointSubnetAssociationLister interface {
	...
	// Get retrieves the AwsVpcEndpointSubnetAssociation from the index for a given name.
...
// Get retrieves the AwsVpcEndpointSubnetAssociation from the index for a given name.
func (s *awsVpcEndpointSubnetAssociationLister) Get(name string) (*v1alpha1.AwsVpcEndpointSubnetAssociation, error) {
