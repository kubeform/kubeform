...
type AwsSsmMaintenanceWindowLister interface {
	...
	// Get retrieves the AwsSsmMaintenanceWindow from the index for a given name.
...
// Get retrieves the AwsSsmMaintenanceWindow from the index for a given name.
func (s *awsSsmMaintenanceWindowLister) Get(name string) (*v1alpha1.AwsSsmMaintenanceWindow, error) {
