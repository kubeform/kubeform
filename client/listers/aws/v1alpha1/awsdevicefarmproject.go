...
type AwsDevicefarmProjectLister interface {
	...
	// Get retrieves the AwsDevicefarmProject from the index for a given name.
...
// Get retrieves the AwsDevicefarmProject from the index for a given name.
func (s *awsDevicefarmProjectLister) Get(name string) (*v1alpha1.AwsDevicefarmProject, error) {
