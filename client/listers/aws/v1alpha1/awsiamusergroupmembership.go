...
type AwsIamUserGroupMembershipLister interface {
	...
	// Get retrieves the AwsIamUserGroupMembership from the index for a given name.
...
// Get retrieves the AwsIamUserGroupMembership from the index for a given name.
func (s *awsIamUserGroupMembershipLister) Get(name string) (*v1alpha1.AwsIamUserGroupMembership, error) {
