...
type AwsAppautoscalingPolicyLister interface {
	...
	// Get retrieves the AwsAppautoscalingPolicy from the index for a given name.
...
// Get retrieves the AwsAppautoscalingPolicy from the index for a given name.
func (s *awsAppautoscalingPolicyLister) Get(name string) (*v1alpha1.AwsAppautoscalingPolicy, error) {
