...
type AwsCognitoIdentityPoolLister interface {
	...
	// Get retrieves the AwsCognitoIdentityPool from the index for a given name.
...
// Get retrieves the AwsCognitoIdentityPool from the index for a given name.
func (s *awsCognitoIdentityPoolLister) Get(name string) (*v1alpha1.AwsCognitoIdentityPool, error) {
