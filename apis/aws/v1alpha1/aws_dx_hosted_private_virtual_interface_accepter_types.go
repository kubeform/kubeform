...
type AwsDxHostedPrivateVirtualInterfaceAccepter struct {
	...
	Spec              AwsDxHostedPrivateVirtualInterfaceAccepterSpec   `json:"spec,omitempty"`
	Status            AwsDxHostedPrivateVirtualInterfaceAccepterStatus `json:"status,omitempty"`
}
...
type AwsDxHostedPrivateVirtualInterfaceAccepterList struct {
	...
	// Items is a list of AwsDxHostedPrivateVirtualInterfaceAccepter CRD objects
	Items []AwsDxHostedPrivateVirtualInterfaceAccepter `json:"items,omitempty"`
}