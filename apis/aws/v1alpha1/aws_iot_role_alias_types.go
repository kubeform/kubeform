...
type AwsIotRoleAlias struct {
	...
	Spec              AwsIotRoleAliasSpec   `json:"spec,omitempty"`
	Status            AwsIotRoleAliasStatus `json:"status,omitempty"`
}
...
type AwsIotRoleAliasList struct {
	...
	// Items is a list of AwsIotRoleAlias CRD objects
	Items []AwsIotRoleAlias `json:"items,omitempty"`
}